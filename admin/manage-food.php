...
?>
  ...
  ?>
    <tr>
      ...
      <td>
        <a href="<?php echo SITEURL . "admin/update-food.php?id=" . $query_food['id'] ?>" class="btn-secondary">
          Update Food
        </a>
        <a href="<?php echo SITEURL . "admin/delete-food.php?id=" . $query_food['id'] ?>" class="btn-danger ms-2">
          Delete Food
        </a>
      </td>
    </tr>
